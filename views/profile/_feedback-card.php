...
<div class="response-card">
    <?= AvatarWidget::widget([
            'userId' => ArrayHelper::getValue($feedback, 'author.id'),
    ...
    <div class="feedback-wrapper">
        ...
        <p class="task">Задание «<?= Html::a(Html::encode($feedback['task']['title']),
                                        Url::toRoute(['/tasks/view/', 'taskId' => $feedback['task']['id']]),
